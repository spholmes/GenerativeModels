---
title: "An Example Workshop on Generative Models"
author: Susan Holmes^[sp.holmes@gmail.com]
...
|--------------------------------|------|
| Simulations                    | 15m  |
| Probabilities and Parameters   | 15m  |
| Comparing Data and Simulations | 10m   |
| Best Practices                 |  5m  |
...
* create synthetic data according to complex hierarchical models in R
